...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com?v=2">
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@700&display=swap?v=2" rel="stylesheet">
<link href="https://coco-factory.jp/ugokuweb/wp-content/themes/ugokuweb/data/reset.css?v=2?v=2" rel="stylesheet">
  <link href="https://coco-factory.jp/ugokuweb/wp-content/themes/ugokuweb/data/4-1-2/css/4-1-2.css?v=2" rel="stylesheet">
...
<header>
  <nav class="kanribotan">
    <div class="kanri">
      <div class="mainmen1u">
      <a class="top" href="login.php">管理者用ログイン</a>
      <a class="top"  href="inquiry.php">問い合わせ</a>
      </div>
    </div>
  </nav>
</header>

<header>ApexLegendsフレンド募集掲示板</header>
  ...
  <div class="apexbox">
   <fieldset>
    <legend>入力してください！</legend>
     ...
     <label><textArea name="naiyou" rows="10" cols="80" placeholder="ここに入力※誹謗中傷等や荒らし行為は無しでお願いします"　></textArea></label><br>
